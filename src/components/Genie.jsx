    ...
    <section className='w-full pt-10 pb-28'>
      <div className='w-11/12 mx-auto'>
        ...
        <div className='grid mt-8 grid-cols-3 gap-8'>
          {genieBox.map(genie => (
          <div key={genie.picture} className='bg-[rgba(134,72,239,0.11)] pb-5 mt-12 rounded-3xl border border-color-primary shadow-2xl p-4 relative'>
            <img className='h-28 -top-12 left-32 absolute' src={`${genie.picture}`} alt="" />
