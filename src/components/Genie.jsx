      ...
      <div className='w-11/12 mx-auto'>
        ...
        <div className='sm:grid mt-8 grid-cols-3 gap-8'>
          {retialPage.genieBox?.map(genie => (
            <div key={genie.head} className='bg-[rgba(134,72,239,0.11)] pb-5 mt-16 md:mt-12 rounded-3xl border border-color-primary shadow-2xl p-4 relative'>
              <img className='h-28 -top-1/2 translate-y-3/4 left-1/2 -translate-x-1/2 absolute' src={`${genie.image}`} alt="" />
              <p className='text-xl text-color-primary md:mt-16 mt-10 text-center font-semibold py-3'>{genie.head}</p>
