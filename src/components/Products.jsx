            ...
            <div className='w-11/12 mx-auto'>
                ...
                <div className='flex md:flex-row flex-col w-full gap-10'>
                    <div className='relative bg-[rgba(134,72,239,0.11)] mt-32 p-6 rounded-xl border border-color-primary basis-1/4'>
                        <img className='absolute -top-36 left-0 h-[50%]' src="./product-1.png" alt="" />
                        <div className='w-full mt-24'>
                            ...
                            <div className='md:mt-6 absolute left-14 text-center'>
                              <DemoButton />
                            </div>
                        </div>
                    </div>
                    <div className='relative bg-[rgba(134,72,239,0.11)] mt-32 p-6 rounded-xl border border-color-primary basis-1/4'>
                        ...
                        <div className='w-full h-[430px] relative mt-24'>
                            ...
                            <div className='mt-6 absolute bottom-0 left-10 text-center'>
                              <DemoButton text='Join Waitlist' />
                            </div>
                        </div>
                    </div>
                    <div className='relative bg-[rgba(134,72,239,0.11)] mt-32 p-6 rounded-xl border border-color-primary basis-1/4'>
                        <img className='absolute -top-36 left-0 h-[50%]' src="./product-3.png" alt="" />
                        <div className='w-full h-[430px] relative mt-24'>
                    ...
                    <div className='relative bg-[rgba(134,72,239,0.11)] mt-32 p-6 rounded-xl border border-color-primary basis-1/4'>
                        <img className='absolute -top-36 left-0 h-[50%]' src="./product-4.png" alt="" />
                        <div className='w-full mt-24'>
                            ...
                            <div className='mt-6 absolute bottom-6 left-16 text-center'>
                              <DemoButton text='Join Waitlist' />
                            </div>
                        </div>
                    </div>
